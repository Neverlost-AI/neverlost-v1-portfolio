...
export function V11Workspace({ view }: { view: "source" | "review" }) {
  ...
  return <div className={styles.workspace}>
    ...
    <main id="v11-main" className={styles.main}>
      ...
      <p className={styles.reconstruction}><Link href="/v1-1/prioritized-evidence">Continue to M05 · Prioritized Evidence</Link> — separate ranking reconstruction; M04 foundation behavior is unchanged.</p>
      <p className={styles.reconstruction}>Continue to M06 · <Link href="/v1-1/capacity-themes">Capacity Themes</Link> → <Link href="/v1-1/denials-bottlenecks">Denials &amp; Bottlenecks</Link></p>
      <p className={styles.reconstruction}><Link href="/v1-1/final-review">Final Review / Reports</Link> · Existing results and historical limits</p>
